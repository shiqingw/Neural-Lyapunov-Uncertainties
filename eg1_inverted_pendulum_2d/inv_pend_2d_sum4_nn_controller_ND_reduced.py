...
--roa_nn_sizes [64,64]\
--roa_nn_activations ['tanh','tanh']\
--roa_batchsize 64\
--roa_adaptive_level_multiplier True\
--roa_adaptive_level_multiplier_step 15\
...
--controller_nn_sizes [16,16,1]\
--controller_nn_activations ['tanh','tanh','identity']\
--controller_slope_multiplier 20\
...
plot_roa_2D(roa_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'roa_true_{}.{}'.format(args.system, args.image_save_format)))
...
plot_state_labels = [r"$\theta$", r"$\omega$"]
plot_levelsets(plot_limits, 0.5, Tx_inv, lyapunov_lqr.lyapunov_function, plot_state_labels, res=32, figsize=(10,10), 
            nlevels=10, full_path=os.path.join(results_dir, 'levelsets_lqr.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_lqr.safe_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'safe_set_lqr.{}'.format( args.image_save_format)))
plot_roa_2D(lyapunov_lqr.largest_safe_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'roa_lqr.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_lqr.exp_stable_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'exp_stable_lqr.{}'.format( args.image_save_format)))
plot_roa_2D(lyapunov_lqr.largest_exp_stable_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'largest_exp_stable_lqr.{}'.format(args.image_save_format)))
...
# Plot ROAs
plot_levelsets(plot_limits, 0.5, Tx_inv, lyapunov_nn.lyapunov_function, plot_state_labels, res=32, figsize=(10,10), 
            nlevels=10, full_path=os.path.join(results_dir, 'levelsets_nn_init.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_nn.safe_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'safe_set_nn_init.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_nn.largest_safe_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'roa_nn_init.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_nn.exp_stable_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'exp_stable_nn_init.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_nn.largest_exp_stable_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'largest_exp_stable_nn_init.{}'.format(args.image_save_format)))
...
plot_levelsets(plot_limits, 0.5, Tx_inv, lyapunov_pre.lyapunov_function, plot_state_labels, res=32, figsize=(10,10), 
           nlevels=10, full_path=os.path.join(results_dir, 'levelsets_quadratic_pre.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_pre.safe_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'safe_set_lyapunov_pre_target.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_pre.largest_safe_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'roa_lyapunov_pre_target.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_pre.exp_stable_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'exp_stable_nn_pre_target.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_pre.largest_exp_stable_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'largest_exp_stable_pre_target.{}'.format(args.image_save_format)))
...
plot_roa_2D(lyapunov_nn.safe_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'safe_set_nn_pretrained.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_nn.largest_safe_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'roa_nn_pretrained.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_nn.exp_stable_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'exp_stable_nn_pretrained.{}'.format(args.image_save_format)))
plot_roa_2D(lyapunov_nn.largest_exp_stable_set_true.reshape(grid_size), plot_limits, plot_state_labels, os.path.join(results_dir, 'largest_exp_stable_nn_pretrained.{}'.format(args.image_save_format)))
...
nominal_closed_loop_dynamics = lambda states: partial_closed_loop_dynamics(states) \
    + torch.cat((torch.zeros([len(states),1], dtype = config.ptdtype, device=device), \
        drift_vec_nn(states)), dim=1) \
    + torch.cat((torch.zeros([len(states),1], dtype = config.ptdtype, device=device), \
...
plot_nested_roas(grid.num_points, idx_small, idx_big, plot_limits, plot_state_labels, 
                    ...
                    full_path=os.path.join(results_dir, 'nested_exp_stable_pretrained.{}'.format(args.image_save_format)))
...
for k in range(args.roa_outer_iters):
    ...
    plot_nested_roas(grid.num_points, idx_small, idx_big, plot_limits, plot_state_labels, 
                    ind_gap_stable=None, ind_exp_stable = idx_exp_stable, ind_true_roa=roa_true, 
                    full_path=os.path.join(results_dir, 'nested_exp_stable_nn_after_training_iter_{}.{}'.format(k+1, args.image_save_format)))
